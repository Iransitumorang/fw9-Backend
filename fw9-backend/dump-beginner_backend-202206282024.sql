...
-- Started on 2022-06-28 20:24:47
...
--
-- TOC entry 3184 (class 2606 OID 16501)
...
--
-- TOC entry 3185 (class 2606 OID 16554)
-- Name: transactions transactions_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transactions
    ADD CONSTRAINT transactions_fk FOREIGN KEY (recipient_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.transactions
    ADD CONSTRAINT transactions_fk_1 FOREIGN KEY (sender_id) REFERENCES public.users(id);


--
-- TOC entry 3187 (class 2606 OID 16564)
-- Name: transactions transactions_fk_2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transactions
    ADD CONSTRAINT transactions_fk_2 FOREIGN KEY (type_id) REFERENCES public.transaction_type(id);


-- Completed on 2022-06-28 20:24:47
